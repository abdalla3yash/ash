class ProjectUtils {
  ...
  static const List<String> description = [
    ...
    "NEXT is a todo app using firebase to login and register and store your tasks with our database, there is a network connection to check your connectivity while you use the app",
  ];
  ...
  static const List<String> links = [
    ...
    "https://github.com/abdalla3yash/next",
  ];
}
